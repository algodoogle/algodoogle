...
My academic research focused on **generative AI for depth estimation in photogrammetry**, giving me deep experience in handling large-scale datasets, 3D reconstruction, and computer vision.
...
*   **Data & Databases:** SQL (Oracle, SQLite, PL/SQL), NoSQL (MongoDB), ETL, Data Modeling, Power BI
*   **Cloud & Dev Tools:** AWS (S3), Docker, Git, PowerShell, SDLC
*   **Hardware & IoT:** Home Assistant, Zigbee, Embedded Software, Fusion 360, 3D Printing
...
*   **API Integration:** Building and connecting diverse technologies via RESTful APIs.
